...
def landing_page():
    ...
    with st.sidebar:
        ...
        model_name = st.selectbox("Select Model",options=model_provider.keys(),index=20, placeholder= "Model")
        provider_name = st.selectbox("Select a Provider",options=model_provider[model_name], placeholder="Provider")		
